...
class Garden_Care_Loader {
	 ...
	 * @return void
	 */
	public function garden_care_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function garden_care_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function garden_care_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function garden_care_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->garden_care_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function garden_care_load( $class ) {
